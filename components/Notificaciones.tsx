    ...
    <div className="relative" ref={caja}>
      ...
      {abierto && (
        <>
          ...
          />
          <div
            className="fixed inset-x-3 bottom-3 z-50 max-h-[72vh] overflow-y-auto rounded-2xl border border-primary/20 bg-ink-900/95 p-4 shadow-gold backdrop-blur-xl sm:absolute sm:inset-auto sm:right-0 sm:top-[52px] sm:max-h-[70vh] sm:w-[360px] sm:p-5"
            role="dialog"
