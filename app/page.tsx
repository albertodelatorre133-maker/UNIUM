...
import { CLASES, COACHES, ESTUDIO } from "@/lib/seed";
      ...
      {DIAS.map((dia, d) => (
        <div key={dia} className="glass p-5">
          <div className="flex items-center justify-between">
            <h3 className="font-display text-lg font-semibold uppercase tracking-[0.18em] text-white">
              {dia}
            </h3>
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden pb-24 pt-32 sm:pt-40">
        <div className="pointer-events-none absolute left-1/2 top-0 h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-primary/10 blur-[140px]" />
        <div className="section relative grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="animate-fade-up">
            ...
            <p className="mt-7 max-w-xl text-base leading-relaxed text-muted-soft sm:text-lg">
            ...
            <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4">
              {METRICAS.map((m) => (
                <div key={m.etiqueta}>
                  ...
                  <p className="mt-1 font-mono text-[10px] uppercase leading-tight tracking-[0.16em] text-muted-dim">
                    {m.etiqueta}
                  </p>
                </div>
              ))}
          ...
          <div className="relative mx-auto w-full max-w-md animate-fade-up">
            <div className="absolute inset-0 animate-glow-pulse rounded-full bg-primary/15 blur-[90px]" />
            <LogoCompleto className="relative w-full rounded-3xl border border-primary/15 bg-black shadow-gold" />
          </div>
        </div>
      </section>

      {/* MÉTODO */}
      <section id="metodo" className="scroll-mt-24 py-24">
        <div className="section">
          <span className="eyebrow">El método UNIUM</span>
          <h2 className="mt-4 max-w-2xl font-display text-4xl font-bold uppercase tracking-tight sm:text-5xl">
            Cuatro pilares en cada <span className="gold-text">sesión</span>
          </h2>
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {METODO.map((m) => (
              <article key={m.titulo} className="glass group p-7 transition hover:border-primary/30">
      ...
      {/* HORARIOS */}
      <section id="horarios" className="scroll-mt-24 py-24">
        <div className="section">
      ...
      {/* COACHES */}
      <section id="coaches" className="scroll-mt-24 py-24">
        <div className="section">
      ...
      {/* UBICACIÓN */}
      <section id="ubicacion" className="scroll-mt-24 py-24">
        <div className="section grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={i.icono} className="flex items-center gap-4">
          ...
          <div className="glass overflow-hidden p-2">
            <iframe
              ...
              src={ESTUDIO.mapa}
              className="h-[340px] w-full rounded-xl border-0 grayscale contrast-125"
              loading="lazy"
            />
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="section">
          <div className="glass-strong relative overflow-hidden px-8 py-16 text-center sm:px-16">
            ...
            <h2 className="relative mt-5 font-display text-4xl font-bold uppercase tracking-tight sm:text-5xl">
